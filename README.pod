...
A Mac OS X System Preferences pane for controlling the PostgreSQL Database Server. Features include:
...
This tool was inspired by the excellent work of
    
=for html <a href="http://johntwang.com/blog/2011/04/03/PostgreSQL-Preference-Pane/">John T Wang</a>.
    
=for text John T Wang
...
=for html <a href="https://github.com/downloads/mckenfra/postgresql-mac-preferences/PostgreSQL.prefPane-v1.0.zip">here</a>

=for text here: https://github.com/downloads/mckenfra/postgresql-mac-preferences/PostgreSQL.prefPane-v1.0.zip
...
We would like to ensure this tool works as smoothly as possible, so please L<Contact Us|/"Contact Us"> if you are still having issues, or have any suggestions for improvements. 
