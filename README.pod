...
Once downloaded, unzip it and then either double-click the F<PostgreSQL.prefPane> file, or drag it to System Preferences to install it.
...
F</Library/LaunchAgents/com.hkwebentrepreneurs.postgresql.plist*>
