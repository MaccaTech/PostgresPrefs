...
=item 0 Delete all server configurations
...
=item 0 Uninstall from System Preferences
...
=item 0 Delete the following log directories if they exist:
...
As per the Version 1.x L<uninstall instructions|https://github.com/mckenfra/postgresql-mac-preferences/tree/master/README-v1.x#Uninstall_Instructions>, please ensure you delete the file C<com.hkwebentrepreneurs.postgresql.plist> if it exists in either of these directories:
