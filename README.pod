...
<tr>
    ...
    <td>Bugfix release
        <ul>
        <li>Automatically detect all running PostgreSQL processes, not just daemons</li>
        <li>Fixed stopping Postgresapp.com server would leave process still running</li>
        <li>Fixed server auto-detection could stop running in some situations</li>
        </ul>
    </td>
</tr>
<tr>
