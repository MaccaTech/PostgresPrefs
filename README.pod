...
Please follow the uninstall instructions described L<here:https://github.com/mckenfra/postgresql-mac-preferences/README-v1>

B<Note:> please ensure you delete the file C<com.hkwebentrepreneurs.postgresql.plist> if it exists in either of these directories:
