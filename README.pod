...
=item * L<Upgrading from Version 1.x|/"Upgrading from Version 1.x">
...
Uninstall from System Preferences
...
=head2 Upgrading from Version 1.x 

Please ensure you delete the file C<com.hkwebentrepreneurs.postgresql.plist> if it exists in either of these directories:
