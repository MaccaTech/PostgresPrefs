...
Delete files named C<org.postgresql.preferences.*.plist> in the following directories:
...
Delete the following log directories:
...
<tr>
    ...
    <td>Bug-fix release
        <ul>
        <li>Automatically detect running Postgres.app server</li>
        </ul>
    </td>
</tr>
<tr>
