...
B<Compatible> with all PostgreSQL installations - including L<Homebrew|http://russbrooks.com/2010/11/25/install-postgresql-9-on-os-x> and <LOne click installer|http://www.postgresql.org/download/macosx/>
